...
const Contact = () => {
  return (
    <div>
            <section className="min-h-screenw-full max-w-7xl px-4 md:px-5 lg:px-5 mx-auto my-5 rounded-3xl  bg-gradient-to-r from-blue-600 via-blue-800 to-blue-900 dark:from-gray-700 dark:via-gray-800 dark:to-gray-900 ">
